    ...
    <div>
      <div className="mx-auto mt-2 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="border-t border-gray-200 px-2 py-2 sm:px-6">
          ...
          <h3 className="text-2xl my-1 font-bold tracking-tight text-red-700">
            email address : {userInfo.email}
          </h3>
          {userInfo.role === 'admin' && (
            <h3 className="text-xl my-5 font-bold tracking-tight text-red-700">
              role : {userInfo.role}
            </h3>
          )}
        </div>

        <div className="border-t border-black px-4 py-1 sm:px-6">
          <button
            onClick={(e) => {
          ...
          <p className="mt-0.5 font-semibold text-m text-black">Your Addresses :</p>
          {userInfo.addresses.map((address, index) => (
            <div key={index}>
              ...
              <div className="flex justify-between gap-x-6 px-5 py-5 my-2 border-2 border-black">
